compare_3year_trend_cases <- function(df = Covid_19, Datesel = ymd(20200101), NYears = 3){
    ...
    # compare deaths
   # g_total_deaths <- Covid19_compare %>%
        # Initialize the canvas:
      #  ggplot() +
        # Now add the aesthetics:
       # geom_line(aes(x = date, y = total_deaths, color =continent), alpha = 0.8,
          #        size = 1)
#
